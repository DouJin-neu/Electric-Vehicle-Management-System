 ...
 * @author adam
 */
public class InvestRequestJPanel extends javax.swing.JPanel
{
    ...
    public InvestRequestJPanel (JPanel userProcessContainer, EcoSystem system, UserAccount account, Organization organization)
    {
        initComponents();
        ...
        jScrollPane1.getVerticalScrollBar().addAdjustmentListener(new AdjustmentListener()
    {
      ...
      {
        int maxValue = jScrollPane1.getVerticalScrollBar().getMaximum() - jScrollPane1.getVerticalScrollBar().getVisibleAmount();
        int currentValue = jScrollPane1.getVerticalScrollBar().getValue();
    ...
    private void initComponents() {
        ...
        add(btnDisagree, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 440, 160, 40));

        btnAgree.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        add(btnAgree, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 440, 150, 40));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel1.setText("Term and Privacy Policy");
    ...
    {//GEN-HEADEREND:event_btnDisagreeActionPerformed
    ...
    {//GEN-HEADEREND:event_btnAgreeActionPerformed
        // TODO add your handling code here:
         sendInvestorRequestJPanel panel = new sendInvestorRequestJPanel(userProcessContainer,system,account,organization);
        userProcessContainer.add("sendInvestorRequestJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
